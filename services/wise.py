...
class WiseService:
    ...
    def creat_transfer(self, quote_id, recipient_id, custom_transaction_id):
...
if __name__ == "__main__":
    ...
    # recipient_id = wise_service.create_recipient("Ines Petrova", "BG80BNBG96611020345678")
    # custom_transaction_id = str(uuid.uuid4())
    # transfer_id = wise_service.creat_transfer(quote_id, recipient_id, custom_transaction_id)
    # print(quote_id)
    # print(recipient_id)
    # print(transfer_id)
    # wise_service.fund_transfer(51790141)
    wise_service.cancel_transfer(51790149)